    ...
    return (
        <div className="flex items-center justify-center gap-12">
                ...
                {isOpen &&
                    <>
                        ...
                        <motion.div
                            ...
                            className="lg:hidden fixed z-50 w-full h-full flex flex-col gap-4 top-0 left-0 bg-zinc-900/20 backdrop-blur-md">
            ...
            <button type="button" onClick={() => setIsOpen(prev => !prev)} className="w-6 sm:w-8 h-fit text-white cursor-pointer hover:outline-2 focus-visible:outline-2 outline-offset-1 outline-zinc-100/20 focus-visible:outline-white rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" className={clsx("transition-all duration-300 ease-in-out", isOpen ? "rotate-90" : "rotate-0")} aria-hidden="true">
